...
namespace ILS_WPF.ViewModels
{
    public class PersonnelVM : BaseVM
    {
        ...
        public PersonnelVM(IWindowService windowService, IDbContextFactory<ILSContext> dbFactory)
        {
            ...
            OpenRegisterWindowCommand = new RelayCommand(_=>windowService.OpenPersonnelRegisterWindow(dbFactory));
            OpenEditWindowCommand = new RelayCommand(arg => windowService.OpenPersonnelEditWindow(dbFactory, (arg as Staff)!));
            _  = LoadData();
        }
        ...
        async Task LoadData()
        {
            ...
            ActualPersonnel = context.Personnel.ToList().Where(
                p =>
