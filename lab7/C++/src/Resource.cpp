...
Resource::Resource(int id, MaterialType materialType, const std::string& name, MeasureUnit measureUnit, float quantity)
    : WarehouseEntry<float>(id, name, materialType), m_measureUnit(measureUnit){
